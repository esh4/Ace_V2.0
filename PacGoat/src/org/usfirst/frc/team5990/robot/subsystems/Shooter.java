...
public class Shooter extends Subsystem {
	...
	DigitalInput hotGoalSensor = new DigitalInput(3); // NOTE: Currently ignored
														// in simulation

	public Shooter() {
		// Put everything to the LiveWindow for testing.
		LiveWindow.addSensor("Shooter", "Hot Goal Sensor", hotGoalSensor);
		LiveWindow.addSensor("Shooter", "Piston1 Reed Switch Front ", piston1ReedSwitchFront);
		LiveWindow.addSensor("Shooter", "Piston1 Reed Switch Back ", piston1ReedSwitchBack);
